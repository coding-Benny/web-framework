...
public class CategorySubcategoriesController {
    ...
    public ResponseEntity<?> addSubcategory(@PathVariable Long parentid, @PathVariable Long childid) {
        // Associating parent with child category...
        categoryService.addChildCategory(categoryService.getCategoryById(childid), categoryService.getCategoryById(parentid));
